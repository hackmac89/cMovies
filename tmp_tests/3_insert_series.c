...
int main(int argc, char** argv)
{
	...
	if( !(addBasicInfoToSeriesContext(&test, "The Big Bang Theory", "Sitcom",
	...
	addActorToSeriesContext(&test, "Johnny Galecki");
  	addActorToSeriesContext(&test, "Jim Parsons");
  	addActorToSeriesContext(&test, "Kaley Cuoco");
  	addActorToSeriesContext(&test, "Simon Helberg");
	addActorToSeriesContext(&test, "Kunal Nayyar");
	addActorToSeriesContext(&test, "Sara Gilbert");
	addActorToSeriesContext(&test, "Melissa Rauch");
	addActorToSeriesContext(&test, "Mayim Bialik");
	addActorToSeriesContext(&test, "Kevin Sussman");
	addActorToSeriesContext(&test, "Laura Spencer");
